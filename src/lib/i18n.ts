...
const en: T = {
  ...
  historyLimitNote: "Free plan · last 7 days",
...
const fr: T = {
  ...
  historyLimitNote: "Plan gratuit · 7 derniers jours",
...
const es: T = {
  ...
  historyLimitNote: "Plan gratuito · últimos 7 días",
...
const de: T = {
  ...
  historyLimitNote: "Kostenloser Plan · letzte 7 Tage",
